	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable(
			...
			CREATE TABLE IF NOT EXISTS `Clients` ( 
				...
				`endpoints` VARCHAR(40) NULL,
				`jobs` VARCHAR(40) NULL,
				`destinations` VARCHAR(40) NULL
			) CHARSET utf8mb4"
		);
		...
		setupIndexes('Endpoints', ['clientid',]);
		...
		setupTable(
			...
			CREATE TABLE IF NOT EXISTS `Jobs` ( 
				...
				`software` INT UNSIGNED NULL,
				`endpoint` INT UNSIGNED NULL,
				`method` INT UNSIGNED NULL,
				`destination` INT UNSIGNED NULL
			) CHARSET utf8mb4"
		);
		setupIndexes('Jobs', ['client','software','endpoint','method','destination',]);
