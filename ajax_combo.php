...
*/
	...
	$lookups = [
		...
		'Jobs' => [
			...
			'software' => [
				'parent_table' => 'Software',
				'parent_pk_field' => 'id',
				'parent_caption' => '`Software`.`name`',
				'parent_from' => '`Software` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'endpoint' => [
				'parent_table' => 'Endpoints',
				'parent_pk_field' => 'id',
				'parent_caption' => '`Endpoints`.`hostname`',
				'parent_from' => '`Endpoints` LEFT JOIN `Clients` as Clients1 ON `Clients1`.`id`=`Endpoints`.`clientid` ',
				'filterers' => ['client' => 'clientid'],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false,
			...
			'method' => [
				'parent_table' => 'Methods',
				'parent_pk_field' => 'id',
				'parent_caption' => 'IF(CHAR_LENGTH(`Methods`.`name`) || CHAR_LENGTH(`Methods`.`software`), CONCAT_WS(\'\', `Methods`.`name`, \' - \', IF(    CHAR_LENGTH(`Software1`.`name`), CONCAT_WS(\'\',   `Software1`.`name`), \'\')), \'\')',
				'parent_from' => '`Methods` LEFT JOIN `Software` as Software1 ON `Software1`.`id`=`Methods`.`software` ',
				'filterers' => ['software' => 'software'],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false,
