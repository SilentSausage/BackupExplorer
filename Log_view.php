...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		...
		"IF(    CHAR_LENGTH(`Endpoints2`.`hostname`) || CHAR_LENGTH(`Destinations1`.`hostname`) || CHAR_LENGTH(`Destinations1`.`type`), CONCAT_WS('',   `Endpoints2`.`hostname`, `Destinations1`.`hostname`, '- ', `Destinations1`.`type`), '') /* Job */" => "job",
		"`Log`.`status`" => "status",
		"`Log`.`results`" => "results",
